...
Tu vas créer 3 comptes et brancher 4 secrets dans le `.env`. Le code est déjà prêt.
...
## Étape 2 — Compte Twilio + Sandbox WhatsApp
...
## Étape 3 — Compte Railway + déploiement
...
## Étape 4 — Variables d'environnement sur Railway
...
| `TWILIO_ACCOUNT_SID` | `AC...` de l'étape 2 |
| `TWILIO_AUTH_TOKEN` | l'auth token de l'étape 2 |
...
## Étape 5 — Connecter le webhook Twilio à Railway
